...
const Dashboard = ({ isSidebarOpen }) => {
  return (
    ...
    >
      ...
      <p className="text-gray-400">Analyze the latest stock trends and indicators</p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold text-blue-300">Stock Price & Moving Average</h2>
          <StockChart />
        </div>
